...
$shop_display    = yanka_get_option( 'woocommerce_shop_page_display' );
$shop_layout     = yanka_get_option( 'wc-shop-layout', 'no' );
$shop_fullwidth  = yanka_get_option( 'wc-shop-fullwidth', 0 );
$pagination_type = yanka_get_option( 'wc-pagination-type', 'number' );
...
?>
	<div class="shop-container <?php echo esc_attr( $shop_container_class ); ?> pt_22 <?php if ( $shop_display == 'subcategories' ) { echo 'pb_60'; } else { echo 'pb_100'; } ?>">
		<div class="row <?php echo esc_attr($layout_classes); ?>">
			...
			<div id="main-content" class="<?php echo esc_attr( $content_class ); ?>">
				...
				<?php if ( have_posts() ) : ?>
					<?php if ( $shop_display != 'subcategories' ) yanka_woocommerce_shop_action(); ?>
					<?php
					/**
					...
					<?php if ( isset($pagination_type) && $pagination_type == 'number' ) : ?>
						<?php if ( $shop_display != 'subcategories' ) : ?>
							<div class="shop-action-bottom pt_20 clearfix">
								<?php
									do_action('yanka_woocommerce_result_count');
