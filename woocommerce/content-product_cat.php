...
<div <?php wc_product_cat_class( '', $category ); ?>>
	...
	<div class="hover-mask">
		...
		<p class="count"><?php if ( $category->count > 0 ) echo apply_filters( 'woocommerce_subcategory_count_html', ' <span >' . esc_html( $category->count ). ' </span>', $category ); echo esc_html__('Product', 'yanka'); ?></p>
		<?php
			/**
