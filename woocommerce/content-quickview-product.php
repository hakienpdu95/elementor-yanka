		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 column-left">
			<div class="single-product-thumbnail pr clearfix outside">
				<div class="single-product-thumbnail-inner pr">
					<div class="p-thumb images thumbnail-slider" data-slick='{"slidesToShow": 1, "rtl": <?php echo $is_rtl; ?>, "slidesToScroll": 1, "asNavFor": ".p-nav", "fade":true,}'>
						<?php
							if ( has_post_thumbnail() ) {
								...
								$html  = '<div class="woocommerce-product-gallery__image--placeholder">';
									$html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_attr__( 'Awaiting product image', 'yanka' ) );
								$html .= '</div>';
							}
                ...
                <?php 
                    if ( $attachment_ids && has_post_thumbnail() ) {
                        ?>
                        <div class="p-nav oh thumbnail-slider" data-slick='{"slidesToShow": 6, "rtl": <?php echo $is_rtl; ?>, "slidesToScroll": 1,"asNavFor": ".p-thumb","arrows": false, "focusOnSelect": true, "responsive":[{"breakpoint": 991,"settings":{"slidesToShow": 4, "rtl": <?php echo $is_rtl; ?>, "vertical":false}}]}'>
                            <?php
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 column-right">
			<div class="summary entry-summary">
				...
				<?php
					 ...
					 */
                    /* get swatch html */
                    add_filter( 'woocommerce_dropdown_variation_attribute_options_html', 'yanka_get_swatch_html', 10, 2 );
                    function yanka_get_swatch_html( $html, $args ) {
                    ...
                    /* print html watch */
                    add_filter( 'tawcvs_swatch_html', 'yanka_swatch_html', 5, 4 );
                    function yanka_swatch_html( $html, $term, $attr, $args ) {
                        /* return `$html` when `WooCommerce Variation Swatches` plugin not installed */
                        if(!function_exists('TA_WCVS')) return $html;
