...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	<h3 class="title-mini-cart"><?php esc_html_e( 'My Cart', 'yanka' ); ?></h3>
				...
				<li class="woocommerce-mini-cart-item clearfix <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<div class="desc">
						<div class="pt-info-mini-cart-item">
							...
							<span class="cart-price db"><?php echo '' . $product_price; ?></span>
						</div>
	...
	<div class="cart-bottom-box">
		<p class="total"><?php esc_html_e( 'Subtotal', 'yanka' ); ?>: <?php echo WC()->cart->get_cart_subtotal(); ?></p>
...
<?php else : ?>
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'yanka' ); ?></p>
<?php endif; ?>
