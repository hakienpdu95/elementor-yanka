...
$layout          = yanka_get_option( 'blog-layout', 'left' );
$blog_design     = yanka_get_option( 'blog-design', 'default' );
$blog_fullwidth  = yanka_get_option( 'blog-fullwidth', 0 );
$pagination_type = yanka_get_option( 'blog-pagination-type', 'number' );
	...
	<div class="<?php echo esc_attr( $blog_container_class ); ?>">
		<div class="row <?php echo esc_attr($layout_classes); ?>">
			<div id="main-content" class="<?php echo esc_attr( $content_class ); ?>">
				<?php if ( have_posts() ) : ?>
					<div class="yanka-loop-blog masonry-container blog-type-<?php echo esc_attr($blog_design); ?>">
				...
				<?php if ( 'loadmore' == $pagination_type || 'infinite' == $pagination_type ) : ?>
					<div class="yanka-ajax-loadmore tc" data-load-more='{"page":"<?php echo esc_attr( $wp_query->max_num_pages ); ?>","container":"masonry-container","layout":"<?php echo esc_attr( $pagination_type ); ?>"}'>
