    ...
    <div class="wrap-header">
        ...
        <div class="header-position header-right text-right header-action block-action">
            <div class="header-block search-block desctop">
                <div id="header-search-6" class="yanka-box-dropdown header-search btn-group">
...
<div class="container-fluid menu-home-6 hidden-md hidden-xs hidden-sm">
    <div class="wrap-header">
        <div class="header-position header-center block-menu">
            <div class="header-block">
