...
<div class="container wpb-1">
    <div class="wrap-header">
        ...
        <div class="header-position header-center hidden-md hidden-xs hidden-sm box-search">
            <div class="header-block">
                <div id="header-search-18" class="header-search btn-group mt-svg woo-search">
                    <?php
...
<div class="header-menu wpb-2 hidden-md hidden-sm hidden-xs">
    <div class="container">
        <div class="wrap-header menu-header-18">
            <div class="header-position header-action">
                <div class="header-block">
                    <div class="pt-menu-categories opened disable">
                        <button class="pt-dropdown-toggle">
                            ...
                            <span class="pt-text">CATEGORIES</span>
                        </button>
                        <div class="pt-dropdown-menu show-menu">
                            <nav>
                                <?php if ( has_nav_menu('category-menu-1') ) : ?>
                                    <?php
                                        if ( class_exists('Yanka_Megamenu_Walker') ) {
                                            $menu = array(
                                                'theme_location'  => 'category-menu-1',
                                                'container_class' => 'category-menu-wrapper',
                                                'menu_class'      => 'yanka-menu category-menu-1 menu-center',
                                ...
                                <?php else : ?>
                                    <div class="category-menu-wrapper">
                                        <ul class="yanka-menu category-menu menu-<?php echo esc_attr($header_menu_align); ?>">
