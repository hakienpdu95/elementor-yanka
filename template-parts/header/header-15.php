...
<div class="container">
    <div class="wrap-header">
        ...
        <div class="header-position header-right text-right header-action block-action">
            <div class="header-block hidden-md hidden-xs hidden-sm">
            ...
            <div class="header-block search-block desctop">
                <div id="header-search-15" class="yanka-box-dropdown header-search btn-group">
            ...
            <?php if ( yanka_woocommerce_activated() && $showAccount == 1 ) : ?>
                <div class="header-block account-icon hidden-md hidden-xs hidden-sm">
